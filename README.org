...
#+begin_src emacs-lisp :tangle no :noweb-ref GPTEL_BACKENDS
(when (and (boundp 'my/local-ai-url)
           (boundp 'my/local-ai-models)
           (localai-reachable-p my/local-ai-url))
  (gptel-make-openai "LocalAI"
    :host (substring my/local-ai-url (length "https://"))
    :protocol "https"
    :endpoint "/v1/chat/completions"
    :key "dummy"
    :stream t
    :models my/local-ai-models)
  )
#+end_src
**** Copilot chat
#+begin_src emacs-lisp :tangle no :noweb-ref GPTEL_BACKENDS
